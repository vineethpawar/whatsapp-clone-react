...
function ChatHeader() {
    ...
    return (
      <div className="theme__green__bg chat__header theme__font">
          ...
          <img src={user4.dp} alt="" className="ch__user__img" />
            <div className="chat__user__details">
                <h4 className="theme__h4">Tejas SA   <span className="theme__uname">@tejas.8sa</span> </h4>
                <h5 className="theme__h5 theme__subfont">last texted today at 11:50 pm</h5>
            </div>
        </div>
